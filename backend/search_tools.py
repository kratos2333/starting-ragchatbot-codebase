...
class CourseOutlineTool(Tool):
    """Tool for retrieving a course outline with lesson list"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the complete outline of a course: course title, course link, and a numbered list of all lesson titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
